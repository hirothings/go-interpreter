...
`
	...
	for i, tt := range tests {
		...
		if !testLetStatement(t, stmt, tt.expectebIdentifier) {
			return
		}
	}
}
...
func testIntegerLiteral(t *testing.T, il ast.Expression, value int64) bool {
	...
	if integ.TokenLiteral() != fmt.Sprintf("%d", value) {
		t.Errorf("integ.TokenLiteral not %d. got=%s, value, integ.TokenLiteral()", value, integ.TokenLiteral())
		return false
	}
	return true
}
